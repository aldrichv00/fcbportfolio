...
// Rapid API Code to retrieve the trending Twitter Trends API Server
...
const options = {
	method: 'POST',
	headers: {
		'x-rapidapi-key': '935d5611e5mshe4cff2bc52c2eecp1048e3jsn0d9d54d589e9',
...
// script to fetch trends in Twitter
...
.then(data => {
	...
	// For loops are user to do repetitive task, in this case to print out each
	// individual element in the graphData array and their respective properties.
	for (let i = 0; i < 25; i++) {
		graphData.push(
		{
